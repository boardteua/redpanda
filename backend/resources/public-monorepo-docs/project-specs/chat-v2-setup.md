...
**Публічні URL на застосунку (без клону репозиторію):** [`GET /docs/openapi.yaml`](/docs/openapi.yaml), [`GET /docs/chat-v2/AI-AGENT-FRIENDLY.md`](/docs/chat-v2/AI-AGENT-FRIENDLY.md), [`GET /docs/project-specs/chat-v2-setup.md`](/docs/project-specs/chat-v2-setup.md). Решта посилань у таблиці нижче вказують шляхи **у Git-клоні**; на прод-хості каталоги `docs/` поза цими трьома файлами після деплою можуть бути відсутні (див. `docker/deploy.sh` і бандл `backend/resources/public-monorepo-docs/`).
...
| Документ | Зміст |
|----------|--------|
| [docs/chat-v2/openapi.yaml](/docs/openapi.yaml) (на сайті) / [копія в репо](../docs/chat-v2/openapi.yaml) | OpenAPI 3.0 — Auth + Chat REST + примітки WS/SPA (узгоджувати з кодом при змінах API) |
...
| [docs/chat-v2/T12-QA.md](../docs/chat-v2/T12-QA.md) | Модерація MVP (бан IP, фільтр, mute/kick) |
| [docs/chat-v2/T14-QA.md](../docs/chat-v2/T14-QA.md) | Інтеграція: скрізний чекліст + API smoke |
| [docs/chat-v2/T16-QA.md](../docs/chat-v2/T16-QA.md) | Візуальний паритет чату з board.te.ua (токени, layout, композер) |
