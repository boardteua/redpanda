...
Цей документ описує, як **без виконання JavaScript SPA** зрозміти продукт, автентифікацію та основні HTTP-флоу. Він узгоджений із [`project-specs/chat-v2-setup.md`](/docs/project-specs/chat-v2-setup.md) (на сайті), [`docs/chat-v2/openapi.yaml`](/docs/openapi.yaml) та оглядами legacy у [`docs/board-te-ua/`](../board-te-ua/) (лише в Git-клоні).
...
| `GET /docs/openapi.yaml` | OpenAPI 3 (файл з монорепо або бандл `backend/resources/public-monorepo-docs/` після деплою) |
...
4. Деталі та коди помилок — у [openapi.yaml](/docs/openapi.yaml) і QA-нотатках T02/T03.
...
**Компенсація:** [OpenAPI](/docs/openapi.yaml), цей файл, `/llms.txt`, markdown/board-te-ua-доки в репозиторії.
