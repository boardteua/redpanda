<template>
    <header class="mb-2 flex w-full min-w-0 flex-shrink-0 flex-col gap-1.5 px-2 py-1 sm:px-3">
        ...
        <p
            v-if="chatTopicLine"
            class="min-w-0 truncate text-sm leading-snug text-[var(--rp-text-muted)]"
            :title="chatTopicLine"
        >
            {{ chatTopicLine }}
        </p>
